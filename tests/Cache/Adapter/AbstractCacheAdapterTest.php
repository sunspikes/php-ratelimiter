...
use Sunspikes\Ratelimit\Cache\Adapter\AbstractCacheAdapter;
...
class AbstractCacheAdapterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->adapterMock = $this->getMockForAbstractClass(AbstractCacheAdapter::class);

        $reflection = new \ReflectionClass(get_class($this->adapterMock));
        $cacheProperty = $reflection->getProperty('cache');
        $cacheProperty->setAccessible(true);
        $cacheProperty->setValue($this->adapterMock, $cache);
    }
